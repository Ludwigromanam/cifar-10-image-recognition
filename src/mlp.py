...
def mlp_1_layer(layer_size):
	...
	W1 = tf.Variable(tf.random_normal([128, layer_size], stddev=0.35))
...
def mlp_2_layer(l1_size, l2_size):
	...
	# weights of the neurons in first layer
	W1 = tf.Variable(tf.random_normal([768, l1_size], stddev=0.35))
	...
	hidden_layer2 = tf.nn.softmax(tf.matmul(hidden_layer, W2) + b2)
